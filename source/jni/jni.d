...
extern (C) {
     ...
     * jboolean constants
     */
    immutable JNI_FALSE =   false;
    immutable JNI_TRUE  =   true;
	...
	alias const(JNIInvokeInterface_)* JavaVM;
   	...
   	struct JNINativeInterface_ {
        ...
        jobject function (JNIEnv* env, jobject obj, jclass clazz, jmethodID methodID, const(jvalue)* args) CallNonvirtualObjectMethodA;
        ...
        jboolean function (JNIEnv* env, jobject obj, jclass clazz, jmethodID methodID, const(jvalue)* args) CallNonvirtualBooleanMethodA;
        ...
        jbyte function (JNIEnv* env, jobject obj, jclass clazz, jmethodID methodID, const(jvalue)* args) CallNonvirtualByteMethodA;
        ...
        jchar function (JNIEnv* env, jobject obj, jclass clazz, jmethodID methodID, const(jvalue)* args) CallNonvirtualCharMethodA;
        ...
        jshort function (JNIEnv* env, jobject obj, jclass clazz, jmethodID methodID, const(jvalue)* args) CallNonvirtualShortMethodA;
        ...
        jint function (JNIEnv* env, jobject obj, jclass clazz, jmethodID methodID, const(jvalue)* args) CallNonvirtualIntMethodA;
        ...
        jlong function (JNIEnv* env, jobject obj, jclass clazz, jmethodID methodID, const(jvalue)* args) CallNonvirtualLongMethodA;
        ...
        jfloat function (JNIEnv* env, jobject obj, jclass clazz, jmethodID methodID, const(jvalue)* args) CallNonvirtualFloatMethodA;
        ...
        jdouble function (JNIEnv* env, jobject obj, jclass clazz, jmethodID methodID, const(jvalue)* args) CallNonvirtualDoubleMethodA;
        ...
        void function (JNIEnv* env, jobject obj, jclass clazz, jmethodID methodID, const(jvalue)* args) CallNonvirtualVoidMethodA;
        ...
        const(jchar)* function (JNIEnv* env, jstring string, jboolean* isCopy) GetStringCritical;
        void function (JNIEnv* env, jstring string, const(jchar)* cstring) ReleaseStringCritical;
